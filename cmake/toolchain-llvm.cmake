...
set(CACHE{COVERAGE_C_FLAGS} TYPE INTERNAL VALUE "-fprofile-instr-generate;-fcoverage-mapping")
set(CACHE{COVERAGE_CXX_FLAGS} TYPE INTERNAL VALUE "-fprofile-instr-generate;-fcoverage-mapping")
set(CACHE{COVERAGE_LINKER_FLAGS} TYPE INTERNAL VALUE "-fprofile-instr-generate;-Wl,--build-id")

set(CACHE{COVERAGE_SCRIPT} TYPE INTERNAL VALUE "collect_llvm_data.sh")
